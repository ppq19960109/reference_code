...
typedef enum
{
    ...
    XM_IA_FDR_MODE_EXTRACT_FEATURE,         /* 人脸检测识别提取人脸图像特征 */
    XM_IA_FDR_MODE_DIRECT_EXTRACT_FEATURE,  /* 直接提取人脸角度和人脸特征 */
    XM_IA_FDR_MODE_DIRECT_GET_FACE_ANGLE,   /* 直接获取人脸角度 */
...
typedef struct
{
    ...
    XM_IA_RECT_S astFaceRect[FACE_MAX_NUM];     /* 待识别人脸区域位置,相对坐标(0~8191) */
