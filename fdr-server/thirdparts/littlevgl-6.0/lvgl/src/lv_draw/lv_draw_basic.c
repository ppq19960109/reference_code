...
#if 0
    printf("lv_draw_letter => pos_p->y %d, font_p->line_height %d \n", pos_p->y, font_p->line_height);
    printf("lv_draw_letter => font_p->base_line %d, pos_y %d \n", font_p->base_line, pos_y);
    printf("lv_draw_letter => box_h %d, ofs_y %d \n", g.box_h, g.ofs_y);
#endif
