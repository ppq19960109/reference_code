                   ...
                   lv_draw_label_hint_t * hint)
{
...
#if 0
    printf("lv_draw_label => coords x1:%d, y1:%d, x2:%d, y2:%d\n", coords->x1, coords->y1, coords->x2, coords->y2);
    printf("lv_draw_label => mask x1:%d, y1:%d, x2:%d, y2:%d\n", mask->x1, mask->y1, mask->x2, mask->y2);

    if(offset != NULL){
        printf("lv_draw_label => offset x:%d, y:%d\n", offset->x, offset->y);
    }
#endif
    ...
    while(txt[line_start] != '\0') {
        ...
        while(i < line_end) {
            ...
            // printf("lv_draw_label => letter_w %d\n", letter_w);
