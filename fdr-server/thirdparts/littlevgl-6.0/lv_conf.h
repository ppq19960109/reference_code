...
#  define LV_MEM_SIZE    (LV_HOR_RES_MAX * LV_VER_RES_MAX * 4)
 ...
 */
#define LV_FONT_CUSTOM_DECLARE    LV_FONT_DECLARE(lv_font_freestyle)

/*Always set a default font from the built-in fonts*/
// #define LV_FONT_DEFAULT        &lv_font_roboto_16
#define LV_FONT_DEFAULT           &lv_font_freestyle
